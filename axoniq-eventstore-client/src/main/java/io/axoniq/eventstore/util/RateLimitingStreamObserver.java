 ...
 * Author: marc
 */
public class RateLimitingStreamObserver<Request,Response> {
    private Logger logger = LoggerFactory.getLogger(RateLimitingStreamObserver.class);
    ...
    public RateLimitingStreamObserver(StartCommand<Request,Response> startCommand, OnNext<Request,Response> onNext, OnError onError) {
