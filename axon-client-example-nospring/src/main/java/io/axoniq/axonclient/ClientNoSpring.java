...
public class ClientNoSpring {
    ...
    public static void main(String[] args) throws Exception {
        ...
        EventStoreConfiguration eventStoreConfiguration = EventStoreConfiguration.newBuilder("event-store-instance-1:8123")
        ...
        try {
            ...
            while (stream.hasNextAvailable(5, TimeUnit.MINUTES) && count > 0) {
                ...
                System.out.println(e.getAggregateIdentifier());
                count--;
            }
        } catch( Exception ex) {
